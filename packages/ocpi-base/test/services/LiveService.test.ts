...
import { etaMinutes, LiveService, roundSoc, SOC_STALE_MS } from '../../src/services/LiveService';
...
function tx(meterValues: Array<{ timestamp: string; sampledValue: any[] }>, over: Record<string, unknown> = {}) {
  return {
    stationId: 2,
    connectorId: 1,
    transactionId: 'tx-1',
